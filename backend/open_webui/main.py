...
app.state.config.PDFTOTEXT_SERVER_URL = PDFTOTEXT_SERVER_URL
app.state.config.MAXPAGES_PDFTOTEXT = MAXPAGES_PDFTOTEXT
app.state.config.USE_TESSERACT = USE_TESSERACT
